...
public class UserService implements IUserService {
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        try {
            User user = userRepository.findById(Long.valueOf(userId) ).orElseThrow(() -> new Exception("User Not Found"));
    ...
    public Response deleteUser(String userId) {
        ...
        try {
            userRepository.findById(Long.valueOf(userId)).orElseThrow(() -> new Exception("User Not Found"));
